                        ...
                        <?php foreach ($slides as $slide) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                    ...
                                    <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="site/slide/delete?id=<?php echo $slide->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a>
                                </td>
                            </tr>
                        <?php } ?>
